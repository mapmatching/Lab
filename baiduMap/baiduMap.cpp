...
void BaiduMap::getNearEdges(double lat, double lon, int k, vector<Edge*>& dest)
{
	//////////////////////////////////////////////////////////////////////////
...
double BaiduMap::shortestPathLength(int ID1, int ID2, double dist1, double dist2, double deltaT)
{
	int size = nodes.size();
