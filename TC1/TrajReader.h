/* 
 * Last Updated at [2014/4/18 14:23] by wuhao
 */
#pragma once
#include <iostream>
#include <fstream>
...
public:
	...
	void outputTrajs(list<Traj*>& trajs, string filePath, int count = INF); //将trajs内count条轨迹按照标准格式输出至filePath
...
void TrajReader::outputTrajs(list<Traj*>& trajs, string filePath, int count /* = INF */)
{
	...
	cout << ">> trajs have been output to " << filePath << endl;
	ofs.close();
}