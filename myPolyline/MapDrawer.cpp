/* 
 * Last Updated at [2014/1/21 15:11] by wuhao
 */
#include "MapDrawer.h"
...
{
	int x = (lon - minLon) * 3600.0 / (((maxLon - minLon) * 3600.0) / (double)r_width);
	int y = (maxLat - lat) * 3600.0 / (((maxLat - minLat) * 3600.0) / (double)r_height);
